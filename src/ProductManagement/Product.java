			...
			do
			{
				...
				do
				{
					...
					else if(update_choice==2)
					{
						...
						pbrand=sc.next();
						PreparedStatement ps=con.prepareStatement("update productdetails set pbrand=? where pid=?");
					...
					else if(update_choice==3)
					{
						...
						pprice=sc.nextInt();
						PreparedStatement ps=con.prepareStatement("update productdetails set pprice=? where pid=?");
						ps.setInt(1,pprice);
						ps.setInt(2,pid);
						result=ps.executeUpdate();
						if(result!=0)
					...
					else if(update_choice==4)
					{
						...
						pmfd=sc.next();
						PreparedStatement ps=con.prepareStatement("update productdetails set pmfd=? where pid=?");
						ps.setString(1,pmfd);
						ps.setInt(2,pid);
						result=ps.executeUpdate();
						if(result!=0)
					...
					else if(update_choice==5)
					{
						...
						pstock=sc.nextInt();
						PreparedStatement ps=con.prepareStatement("update productdetails set pstock=? where pid=?");
						ps.setInt(1,pstock);
						ps.setInt(2,pid);
						result=ps.executeUpdate();
						if(result!=0)
		...
		try
		{
			...
			do
			{
				...
				do
				{
					...
					if(del_sel==1)
					{
						PreparedStatement ps=con.prepareStatement("delete from productdetails where pid=?");
						System.out.println("Enter the Product ID : ");
					...
					{
						PreparedStatement ps=con.prepareStatement("delete from productdetails where pname=?");
						System.out.println("Enter the Product Name : ");
					...
					{
						PreparedStatement ps=con.prepareStatement("delete from productdetails where pbrand=?");
						System.out.println("Enter the Product Brand : ");
